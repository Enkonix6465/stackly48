...
const AdminDashboard = () => {
  ...
  const chartOptions = {
    responsive: true,
    plugins: {
      legend: { labels: { color: theme === "dark" ? "#FFE6CC" : "#FF6600" }, position: "top" },
      title: { display: true, font: { size: 22, weight: "bold" }, color: theme === "dark" ? "#FFE6CC" : "#FF6600" },
      tooltip: { mode: "index", intersect: false },
    },
    scales: {
      x: { ticks: { color: theme === "dark" ? "#FFE6CC" : "#FF6600", maxRotation: 90, minRotation: 45 }, grid: { color: theme === "dark" ? "#33211A" : "#FFE6CC" } },
      y: { ticks: { color: theme === "dark" ? "#FFE6CC" : "#FF6600" }, grid: { color: theme === "dark" ? "#33211A" : "#FFE6CC" }, beginAtZero: true },
    },
  };
              ...
              <table className={themedClass(
                ...
                <tbody>
                  {allUserData.map((u, idx) => (
                    <tr key={idx} style={{ borderBottom: "1px solid #cbd5e1", backgroundColor: idx % 2 === 0 ? (theme === "dark" ? "#33211A" : "#fff4e6") : (theme === "dark" ? "#1E2A38" : "#FFE6CC") }}>
          ...
          <section className={themedClass(
            ...
            <div style={{ maxHeight: 200, overflowY: "auto" }}>
              {recentLogins.map((entry, idx) => (
                <div key={idx} className="activity-item flex justify-between p-3 border-b border-orange-200">
