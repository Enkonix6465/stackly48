              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-700 dark:text-gray-300">{t(`holisticFeature${i}`, language)}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-start gap-4">
                <img src={dietIcon} alt="Guided Sessions" className="w-12 h-12 object-contain" />
                <div>
            ...
            >
              <div className="flex items-start gap-4">
                <img src={exerciseIcon} alt="Mindfulness Coaching" className="w-12 h-12 object-contain" />
                <div>
